...
describe('QuarterId', () => {
  it('should parst gueltige Quarter IDs', () => {
    // given
    // when + then
    expect(QuarterId.parse('2026-Q2').toString()).toBe('2026-Q2');
  });

  it('should lehnt invalide Quarter IDs ab', () => {
    // given
    // when + then
  ...
  it('should berechnet next und previous korrekt', () => {
    // given
    // when + then
  ...
  it('should vergleicht Quarter IDs korrekt', () => {
    // given
