...
export class BingoComponent implements OnInit {
  ...
  drop(index: number) {
    ...
    // Projekte tauschen
    [this.projects[this.dragSourceIndex], this.projects[index]] = [
      this.projects[index],
      this.projects[this.dragSourceIndex],
    ];
    // Done-Status mit tauschen
    [this.done[this.dragSourceIndex], this.done[index]] = [
      this.done[index],
      this.done[this.dragSourceIndex],
    ];
